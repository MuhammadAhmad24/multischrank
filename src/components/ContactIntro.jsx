                    ...
                    {cards.map((card, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group relative overflow-hidden rounded-2xl border border-white/10 bg-[#0f0f10] p-8 transition-colors duration-300 hover:border-white/20 hover:bg-[#141416]"
                            >
