                ...
                >
                    <div className="pointer-events-none absolute inset-0">
                        <motion.div
                            ...
                            transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }}
                            className="absolute left-1/2 top-1/2 h-112 w-md -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-400/10 blur-3xl"
                        />
                        <div className="absolute left-[15%] top-[20%] h-40 w-40 rounded-full bg-orange-300/6 blur-3xl" />
                        <div className="absolute bottom-[15%] right-[10%] h-52 w-52 rounded-full bg-orange-500/8 blur-3xl" />
                        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_20%,rgba(249,115,22,0.06),transparent_28%)]" />
                    </div>
                        ...
                        <div className="mt-10 w-full max-w-md">
                            ...
                            <div className="h-1.5 w-full overflow-hidden rounded-full bg-white/10">
                                <motion.div
                                    ...
                                    className="h-full rounded-full bg-linear-to-r from-orange-200 via-orange-300 to-orange-500"
                                />
                            </div>
                        </div>
